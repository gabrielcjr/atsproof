...
TRANSLATIONS: Dict[str, Dict[str, Any]] = {
    "en": {
        ...
        "error_pdf_read": "Unable to read the uploaded resume. Please make sure the PDF is text-based (not a scanned image) and under 200KB.",
        "error_footer_note": "PDF must be text-based (max 200KB, max 3 pages).",
    ...
    "pt": {
        ...
        "error_pdf_read": "Não foi possível ler o currículo enviado. Certifique-se de que o PDF contenha texto selecionável (não seja imagem escaneada) e tenha menos de 200KB.",
        "error_footer_note": "O PDF deve ser baseado em texto (máx 200KB, máx 3 páginas).",
